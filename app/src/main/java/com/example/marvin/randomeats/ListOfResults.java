...
public class ListOfResults extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //GET RESTAURANTS
        myGPS = new GPS(ListOfResults.this);
        if (myGPS.canGetLocation()) {
            ...
            new AsyncTask<Void, Void, ArrayList<Business>>() {
                ...
                public ArrayList<Business> doInBackground(Void... params) {
                    String businesses = Yelp.getYelp(ListOfResults.this).search("restaurants", latitude, longitude);
                    try {
            ...
            new AsyncTask<Void, Void, ArrayList<Business>>() {
                @Override
                public ArrayList<Business> doInBackground(Void... params) {
                    String businesses = Yelp.getYelp(ListOfResults.this).search("restaurants", "Los Angeles, CA");
                    try {
                        return processJson(businesses);
                    } catch (Exception e) {
                        return null;
    ...
    public void set_images(){
        favorite1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ListOfResults.this, Favorites.class);
    ...
    //SET THE ON CLICK FOR NAVIGATING TO RESTAURANTS
